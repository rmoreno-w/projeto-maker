    ...
    useEffect(() => {
        if (isDialogEditing == true) {
            ...
            const newEditingObject = {
                ...
                base_price:
                    Number(dialogServiceBasePrice) !== originalObject?.base_price && Number(dialogServiceBasePrice),
            };
        ...
        apiClient
            ...
            .then((data) => {
                ...
                const updatedServices = services.map((service) => {
                    return service.id == dialogServiceId ? { ...service, ...editedFields } : service;
                });
        ...
        <main className=' bg-makerBg border-4 border-makerYellow mx-[120px] my-[60px] rounded-3xl overflow-hidden'>
            ...
            >
                ...
                <div className='flex flex-col gap-4 text-ellipsis'>
                    <Input currentValue={dialogServiceName} label='Nome:' onChangeValue={setDialogServiceName} />
                    <Input
